...
Adapted from original code written by Andrej Karpathy (@karpathy)
Original code available here: https://gist.github.com/karpathy/d4dee566867f8291f086
BSD License
"""
import numpy as np
...
print('Reading input file: %s' % (file_name))
data = open(file_name, 'r').read()      # should be simple plain text file
# data = data.split()                     # uncomment for word level model instead of characters
chars = list(set(data))                 # create a list of unique characters
data_size, vocab_size = len(data), len(chars)
print('Input file has %d total characters, containing %d unique characters.' %
      (data_size, vocab_size))

# create mappings between unique characters and their index (within vocab list) in both directions
